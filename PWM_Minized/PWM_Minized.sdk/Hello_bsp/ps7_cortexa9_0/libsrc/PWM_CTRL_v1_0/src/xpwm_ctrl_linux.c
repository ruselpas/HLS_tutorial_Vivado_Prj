...
typedef struct {
    ...
    XPwm_ctrl_uio_map maps[ MAX_UIO_MAPS ];
} XPwm_ctrl_uio_info;

/***************** Variable Definitions **************************************/
static XPwm_ctrl_uio_info uio_info;
...
static int uio_info_read_name(XPwm_ctrl_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XPwm_ctrl_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XPwm_ctrl_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XPwm_ctrl_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XPwm_ctrl_Initialize(XPwm_ctrl *InstancePtr, const char* InstanceName) {
	XPwm_ctrl_uio_info *InfoPtr = &uio_info;

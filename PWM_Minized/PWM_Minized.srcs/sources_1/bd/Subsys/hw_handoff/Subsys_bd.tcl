...
################################################################
# This is a generated script based on design: Subsys
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set OutPWM_V_0 [ create_bd_port -dir O -from 0 -to 0 -type data OutPWM_V_0 ]
  ...
  set PWM_CTRL_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:PWM_CTRL:1.0 PWM_CTRL_0 ]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins PWM_CTRL_0/s_axi_CTRL] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net processing_system7_0_DDR [get_bd_intf_ports DDR] [get_bd_intf_pins processing_system7_0/DDR]
  connect_bd_intf_net -intf_net processing_system7_0_FIXED_IO [get_bd_intf_ports FIXED_IO] [get_bd_intf_pins processing_system7_0/FIXED_IO]
  connect_bd_intf_net -intf_net processing_system7_0_M_AXI_GP0 [get_bd_intf_pins axi_interconnect_0/S00_AXI] [get_bd_intf_pins processing_system7_0/M_AXI_GP0]

  # Create port connections
  connect_bd_net -net PWM_0_OutPWM_V [get_bd_ports OutPWM_V_0] [get_bd_pins PWM_0/OutPWM_V]
  connect_bd_net -net PWM_CTRL_0_EN_r_V [get_bd_pins PWM_0/EN_V] [get_bd_pins PWM_CTRL_0/EN_r_V]
  connect_bd_net -net PWM_CTRL_0_LoadValCnt_r_V [get_bd_pins PWM_0/LoadValCnt_V] [get_bd_pins PWM_CTRL_0/LoadValCnt_r_V]
  connect_bd_net -net PWM_CTRL_0_Rst_r_V [get_bd_pins PWM_0/Rst_V] [get_bd_pins PWM_CTRL_0/Rst_r_V]
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins PWM_0/ap_rst_n] [get_bd_pins PWM_CTRL_0/ap_rst_n] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins PWM_0/ap_clk] [get_bd_pins PWM_CTRL_0/ap_clk] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins processing_system7_0/FCLK_RESET0_N]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs PWM_CTRL_0/s_axi_CTRL/Reg] SEG_PWM_CTRL_0_Reg

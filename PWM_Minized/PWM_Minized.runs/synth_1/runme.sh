...
HD_PWD='D:/XilinxPrj/PWM_Minized/PWM_Minized.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsys_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Subsys_wrapper.tcl

...
HD_PWD='D:/XilinxPrj/PWM_Minized/PWM_Minized.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Subsys_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Subsys_wrapper.tcl -notrace
